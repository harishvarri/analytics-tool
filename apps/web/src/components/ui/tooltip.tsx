...
/**
 * Convenience wrapper: <InfoTip>explanation</InfoTip> rendered next to a label.
 * Self-contained (includes its own Provider) so callers don't have to wire one.
 */
function InfoTip({ children, label }: { children: React.ReactNode; label: React.ReactNode }) {
  return (
